...
describe('MoonComponent', () => {
  ...
  describe('getQuakes', () => {
    it('should fetch quakes data successfully', () => {
      ...
      jest.spyOn(moonService, 'getQuakes').mockReturnValue(of(mockResponse));

      component.getQuakes(mockFilters as any);

      expect(component.isLoading).toBe(true);
      expect(moonService.getQuakes).toHaveBeenCalledWith({
        planet: 'mars',
        ...mockFilters
      });
    ...
    it('should handle error and set fallback data', () => {
      ...
      jest.spyOn(moonService, 'getQuakes').mockReturnValue(throwError(() => mockError));
